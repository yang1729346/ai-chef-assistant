...
async def serve_memory_selector():
    memory_selector_path = os.path.join(static_dir, "memory-selector.html")
    if os.path.exists(memory_selector_path):
        return FileResponse(memory_selector_path)
    # 如果没有memory-selector.html，返回原来的index.html
